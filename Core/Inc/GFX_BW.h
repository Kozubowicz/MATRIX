...
#define GFX_DrawPixel(x,y,color) MAX7219_SetPixel(x,y,color)
#define WIDTH MAX7219_X_PIXELS
#define HEIGHT MAX7219_Y_PIXELS
#define PIXEL_BLACK	MAX7219_BLACK
#define PIXEL_WHITE	MAX7219_WHITE
#define PIXEL_INVERSE	MAX7219_INVERSE
